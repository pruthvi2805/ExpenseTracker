  ...
  return (
    <div className="prose prose-sm max-w-none">
      ...
      <ul className="list-disc pl-5 text-gray-700">
        <li><b>Tiles</b>: Income (from <b>Income</b>), Planned Spend and Actual Spend (from <b>Budget</b>), and Net (Income − Actual).</li>
        <li><b>Savings</b>: 
          <ul className="pl-5 list-disc">
            <li><b>Current savings</b>: What you have now (set in <b>Settings</b>).</li>
            <li><b>After Month</b>: <i>Current savings + Net</i>. This is your projected end‑of‑month balance.</li>
        ...
        <li><b>Budget Status</b>: Shows <i>Actual − Plan</i> as signed amounts:
          <ul className="pl-5 list-disc">
      ...
      <p className="text-gray-700">Plan your month and record what you actually spend. Everything auto‑saves after a short pause. If you prefer, you can copy last month’s plan and then tweak it.</p>
      <ul className="list-disc pl-5 text-gray-700">
        <li><b>Tabs</b>:
          <ul className="pl-5 list-disc">
        ...
        <li><b>Columns</b>: Subcategory | Planned | Actual | Δ. Δ is <i>Actual − Plan</i> for that row (red = overspend, green = under plan).</li>
      ...
      <ul className="list-disc pl-5 text-gray-700">
        ...
        <li>All changes auto‑save; Total Income updates live and feeds the Dashboard Net and Savings cards.</li>
